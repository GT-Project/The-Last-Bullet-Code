...
//	>> 762
// ========================================================================
class CItem_762 : public CItem
{
public:
	DECLARE_CLASS(CItem_762, CItem);
	...
	bool MyTouch(CBasePlayer *pPlayer)
	{
		if (ITEM_GiveAmmo(pPlayer, SIZE_AMMO_762, "762"))
		{
			if (g_pGameRules->ItemShouldRespawn(this) == GR_ITEM_RESPAWN_NO)
			{
				UTIL_Remove(this);
...
LINK_ENTITY_TO_CLASS(item_box_762, CItem_762);
LINK_ENTITY_TO_CLASS(item_ammo_762, CItem_762);
